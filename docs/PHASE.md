...
> **버전**: v1.3
> **작성일**: 2026-03-22
> **최종수정일**: 2026-04-14 (WORKFLOW Git·PR 절차 안내)
...
아래 **Phase 전체 요약** 표의 **기간** 열은 외부 스케줄 정본(`00-스케줄_v3.1`)에 맞춘 **계획 캘린더**이다.  
**실제 구현 완료 범위·Task 단위 상태**는 본 저장소 **[TASKS.md](TASKS.md)** 및 `develop` 브랜치를 **정본**으로 본다.  
기능이 계획상 Phase보다 **앞서** 납품된 경우가 있으므로, 표의 Phase 번호·「대기」만으로 현재 진척을 판단하지 않는다.  
**브랜치·PR·머지 방식**은 [WORKFLOW.md](WORKFLOW.md) §1·§4를 본다.
...
> **기간**: 2026-04-15 ~ 05-05 (3주) — 외부 일정 정본상 계획 구간
> **마일스톤**: M2. 설계 완료
> **완료일(저장소)**: 2026-04-09 — 본 저장소에서 설계 산출물이 확정·반영된 시점
...
> **기간**: 2026-05-06 ~ 05-19 (2주) — 외부 일정 정본
> **Sprint Goal (`00-스케줄_v3.1`)**: 이슈 CRUD + 워크플로우 기본 — **FR-001~007, FR-013~014**
> **Task**: [TASKS.md - Phase 3](TASKS.md#phase-3--개발-sprint-1-tasks)
>
> **저장소 진척**: Phase 3·이후 Phase에 해당하는 다수 Task가 [TASKS.md](TASKS.md) 기준 **DONE**일 수 있다. 위「진행 중」은 **캘린더 상의 Sprint 구간 라벨**이며, 실제 완료 여부는 TASKS를 본다.
...
| v1.3 | 2026-04-14 | 「일정 vs 저장소 진척」에 Git·PR·머지 → `WORKFLOW.md` §1·§4 안내 추가 |
