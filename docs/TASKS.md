...
> **버전**: v1.39
> **작성일**: 2026-03-22
> **최종수정일**: 2026-04-14 (T-629 프로젝트 설정 아카이브·연동 안내)
...
| T-629 | 아카이브·연동 설정 UI | Frontend | DONE | SCR-013; 설정 아카이브 토글·`GET /projects/by-key/{key}`·외부 연동(T-625) 안내 — 자동 아카이브 규칙 API는 T-617 | T-628 |
