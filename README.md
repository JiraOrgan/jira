...
주요 웹 경로: `/`(프로젝트 목록), `/project/{key}`, `/project/{key}/settings`, `/project/{key}/board`, `/project/{key}/backlog`, `/project/{key}/kanban`, `/project/{key}/sprints`, `/project/{key}/jql`, `/project/{key}/roadmap`, `/project/{key}/issues/new`, `/issue/{issueKey}`.
